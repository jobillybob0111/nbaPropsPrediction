...
function App() {
  ...
  const generateRandomPrediction = () => {
    const hitChance = Math.floor(Math.random() * 40) + 55;
    ...
    // Mock user line (average of historical + some variance)
    const avgValue = historicalData.reduce((sum, d) => sum + d.value, 0) / historicalData.length;
    const userLine = Math.round(avgValue);

    // Mock matchup difficulty
    const difficulties = ['Easy Matchup', 'Moderate Matchup', 'Tough Matchup'];
    const difficulty = difficulties[Math.floor(Math.random() * 3)];
    const isEasy = difficulty === 'Easy Matchup';
        ...
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="relative">
              ...
              <div className="w-8 h-8 relative bg-gradient-to-br from-electric-blue to-neon-green rounded-lg flex items-center justify-center font-bold text-zinc-950 text-sm">
                AI
              </div>
            </div>
            <span className="font-bold tracking-tight text-lg">Prop<span className="text-gray-400 font-normal">Predictor</span></span>
          </div>
      ...
      <div className="max-w-5xl mx-auto px-4 py-12 relative z-10 flex flex-col items-center">
        ...
        >
          ...
          <p className="text-lg text-gray-400 max-w-2xl mx-auto leading-relaxed">
            Leverage our proprietary machine learning algorithms to analyze player performance trends and generate high-confidence prop predictions.
          </p>
        </motion.div>
        ...
        >
          <div className="p-6 md:p-8 space-y-8">
            ...
            <div className="relative group">
              <label className="text-xs font-semibold text-gray-500 uppercase tracking-wider mb-2 block">Player Analysis</label>
              <div className="relative">
                ...
                <div className="p-6 md:p-8 border-b border-white/5 flex flex-col md:flex-row md:items-center justify-between gap-4">
                  <div>
                    ...
                    <div className="flex items-center gap-2 text-gray-400 text-sm mt-1">
                      <span>{result.stat} Projection</span>
                  ...
                  <div className={`px-4 py-2 rounded-full border flex items-center gap-2 ${
                    ...
                    <span className="text-sm font-semibold">{result.difficulty}</span>
                  </div>
                </div>
                  ...
                  <div className="grid md:grid-cols-2 gap-8 mb-8">
                    ...
                    <div className="bg-black/20 rounded-xl p-6 border border-white/5 flex flex-col items-center justify-center relative overflow-hidden group">
                      ...
                      <div className="mt-4 text-center z-10">
                        ...
                        <p className="text-sm text-gray-500 mt-1">AI Confidence Model v2.1</p>
                      </div>
                    </div>
                    ...
                    <div className="space-y-4">
                      <div className="bg-black/20 rounded-xl p-5 border border-white/5 flex items-center justify-between">
                         <div>
                           <div className="text-sm text-gray-500 font-medium mb-1">Projected Line</div>
                           <div className="text-3xl font-bold text-white tracking-tight">{result.userLine} <span className="text-lg text-gray-600 font-normal">pts</span></div>
                         </div>
